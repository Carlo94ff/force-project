...
//Home Button
var arrowpicHome = document.getElementById('arrowpic-home');
var gotodivHome = document.getElementById('gotodiv-home');

gotodivHome.onmouseover = function changeimgHome(){
    arrowpicHome.src = '../forceproject/images/chevron-yellow-r.png';
}

gotodivHome.onmouseleave = function resetimgHome(){
    arrowpicHome.src = '../forceproject/images/chevron-black-r.png';
}
